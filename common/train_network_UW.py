...
from image_utils import tf_categorical_accuracy, rescale_intensity, data_augmenter, crop_image
...
frozenLayers = 4 # number of layers to freeze for transfer learning
log_dir = '/home/pcorrado/Cardiac-DL-Segmentation-Paper/log_UW_layers_frozen' # Directory for saving the log file
checkpoint_dir = '/home/pcorrado/Cardiac-DL-Segmentation-Paper/model_UW_layers_frozen' # Directory for saving the trained model
...
if __name__ == '__main__':
    ...
    model_name = 'FCN_sa_level{1}_filter{2}_{3}_batch{4}_iter{5}_lr{6}'.format(
        n_level, n_filter[0], ''.join([str(x) for x in n_block]),
